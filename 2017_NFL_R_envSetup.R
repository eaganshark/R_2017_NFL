...
# Local:
setwd("G:\\R\\2017_NFL_R")

rm(games)
#games <- read.table("nfl_g_all_output.txt", sep=",", header=TRUE)
games <- read.table("nfl_g.txt", sep=",", header=TRUE, stringsAsFactors = TRUE)
